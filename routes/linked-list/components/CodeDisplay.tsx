...
import { ListOperation, ListKind } from '../../../types';
import { getSnippet } from '../../../services/codeSnippets';
...
const CodeDisplay: React.FC<Props> = ({ operation, listKind }) => {
  ...
  const code = getSnippet(listKind, operation, lang);
